        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div>
              ...
              <p className="text-stone-300 text-sm md:text-base mt-4 font-semibold">
            ...
            <div className="glass-card-gold p-4 rounded-xl border border-[#D4AF37]/30 flex items-center justify-between shadow-md">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">4.3 / 5.0 Google-Bewertung</h4>
                  <p className="text-xs text-stone-400 font-semibold">Basierend auf 35 verifizierten Rezensionen</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 rounded-xl glass-card-gold border border-[#D4AF37]/30">
                ...
                <div>
                  <h4 className="text-sm font-bold text-stone-300 uppercase tracking-wider">Standort</h4>
                  <p className="text-white text-xs mt-1 font-extrabold">Schossacher Garage</p>
                  <p className="text-stone-400 text-xs font-semibold">Im Schossacher 22, 8600 Dübendorf / Schweiz</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 rounded-xl glass-card-gold border border-[#D4AF37]/30">
                ...
                <div>
                  <h4 className="text-sm font-bold text-stone-300 uppercase tracking-wider">Telefon & Kontakt</h4>
                  <a href="tel:0448207474" className="text-[#FFD700] font-mono text-base font-bold hover:underline block">
                    044 820 74 74
                  </a>
                  <p className="text-stone-400 text-xs mt-0.5 font-semibold">Mo - Fr: 08:00 - 18:00 Uhr</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 rounded-xl glass-card-gold border border-[#D4AF37]/30">
                ...
                <div>
                  <h4 className="text-sm font-bold text-stone-300 uppercase tracking-wider">Öffnungszeiten</h4>
                  <div className="text-xs text-stone-300 space-y-1 mt-1 font-mono font-bold">
