            ...
            <div key={idx} className="glass-card-gold p-8 relative flex flex-col justify-between hover:border-[#FFD700]">
              ...
              <div className="space-y-4 relative z-10">
                <div className="flex text-[#FFD700] gap-1">
                  ...
                  <Star className="w-4 h-4 fill-amber-500/30 text-[#FFD700]" />
                </div>
                <p className="text-stone-300 text-sm italic leading-relaxed font-semibold">
                  "{rev.text}"
                </p>
              </div>
              ...
              <div className="pt-6 border-t border-[#D4AF37]/20 mt-6 flex items-center justify-between">
                <div>
                  ...
                  <span className="text-xs text-stone-400 font-semibold">{rev.location} • {rev.car}</span>
                </div>
              </div>
            </div>
          ))}
