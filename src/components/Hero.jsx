...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-[92vh] flex items-center pt-28 pb-20 overflow-hidden bg-[#07090e]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#07090e] via-[#07090e]/60 to-transparent"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="badge-cyber shadow-[0_0_20px_rgba(6,182,212,0.25)]">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.08]">
              ...
              <span className="text-cyan-gradient font-serif block mt-3 drop-shadow-2xl">
                Schossacher Garage
              </span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <a href="/autohandel" className="btn-primary-cyan text-decoration-none text-base px-8 py-4 shadow-[0_10px_35px_rgba(6,182,212,0.35)]">
                <Car className="w-5 h-5" />
                Occasionen Entdecken
                <ArrowRight className="w-4 h-4 ml-1" />
              </a>

              <a href="/werkstatt" className="btn-glass-subtle text-decoration-none text-base px-8 py-4">
            ...
            <div className="pt-8 grid grid-cols-3 gap-6 border-t border-white/10 mt-8">
              <div>
                <span className="block text-2xl sm:text-3xl font-bold text-white font-serif text-cyan-gradient">15+ Jahre</span>
                <span className="text-xs text-slate-400 font-medium">Erfahrung & Expertise</span>
              </div>

              <div>
                <span className="block text-2xl sm:text-3xl font-bold text-white font-serif text-amber-gradient">100% MFK</span>
                <span className="text-xs text-slate-400 font-medium">Schweizer Abnahmegarantie</span>
              </div>

              <div>
                <span className="block text-2xl sm:text-3xl font-bold text-white font-serif text-titanium-gradient">4.9 / 5.0</span>
          ...
          <div className="lg:col-span-5 relative hidden lg:block">
            <div className="glass-card-cyber p-6 border-cyan-500/30 shadow-2xl relative space-y-6 transform hover:scale-[1.02] transition-all duration-500">
              <div className="relative h-64 rounded-xl overflow-hidden border border-white/10 shadow-inner">
                ...
                <span className="absolute top-3 left-3 badge-amber !text-[10px] !py-1 !px-3">
                  🔥 Aktuelles Highlight
                </span>
                <div className="absolute bottom-3 left-4 right-4 flex justify-between items-end">
                  ...
                  <span className="text-lg font-bold font-mono text-cyan-400">CHF 289,900.-</span>
                </div>
              </div>
              ...
              <div className="bg-white/5 p-4 rounded-xl border border-white/10 flex items-center justify-between">
                ...
                <a href="/kontakt" className="btn-primary-cyan !py-2 !px-4 !text-xs text-decoration-none">
                  Buchen
                </a>
              </div>
            </div>
