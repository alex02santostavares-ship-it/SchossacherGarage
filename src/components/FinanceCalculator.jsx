...
export default function FinanceCalculator() {
  ...
  return (
    <section className="py-20 relative bg-[#0d0e12]">
      <div className="container">
        <div className="glass-card-gold p-8 md:p-12 border-[#F59E0B]/40 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="space-y-3 pt-2">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3 text-xs md:text-sm text-slate-100 font-medium">
                    <div className="w-5 h-5 rounded-full bg-amber-500/20 border border-[#F59E0B] flex items-center justify-center text-[#FBBF24]">
            ...
            <div className="lg:col-span-6">
              <div className="bg-[#12141a] p-6 md:p-8 rounded-2xl border border-[#F59E0B]/40 shadow-2xl space-y-6">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <span className="text-xs uppercase tracking-wider text-slate-300 font-extrabold">Leasing Rechner</span>
                  <span className="text-xs font-mono text-[#FBBF24] bg-amber-500/20 px-3 py-1 rounded-full border border-[#F59E0B]/40 font-bold">
                    Sollzins 4.9% p.a.
                  </span>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-xs font-semibold">
                    ...
                    <span className="text-[#FBBF24] font-mono text-sm font-bold">CHF {vehiclePrice.toLocaleString('de-CH')}.-</span>
                  </div>
                  <input
                    type="range"
                    min="10000"
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-xs font-semibold">
                    ...
                    <span className="text-[#FBBF24] font-mono text-sm font-bold">CHF {downPayment.toLocaleString('de-CH')}.-</span>
                  </div>
                  <input
                    type="range"
                    min="0"
                ...
                <div className="bg-gradient-to-r from-amber-500/20 via-amber-500/10 to-transparent p-5 rounded-xl border border-[#F59E0B]/40 flex items-center justify-between">
                  <div>
                    <span className="text-[11px] uppercase tracking-wider text-slate-300 block font-bold">Geschätzte Monatsrate</span>
                    <span className="text-3xl font-bold font-mono text-[#FBBF24] font-serif">
                      CHF {monthlyPayment.toLocaleString('de-CH')}.-
                    </span>
                    <span className="text-[10px] text-slate-300 block">/ Monat inkl. MwSt.</span>
                  </div>
